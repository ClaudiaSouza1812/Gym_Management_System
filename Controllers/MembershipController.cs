...
namespace P02_2_ASP.NET_Core_MVC_M01_ClaudiaSouza.Controllers
{
    public class MembershipController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MembershipId,MembershipType,DiscountPercentage")] Membership membership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MembershipId,MembershipType,DiscountPercentage")] Membership membership)
        {
